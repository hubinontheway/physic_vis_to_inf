...
class ImageLogger(Callback):
    ...
    def __init__(self, val_samples, num_samples=4, log_interval=1):
        ...
        self.val_ir0 = val_samples.get("ir0")
        if self.val_ir0 is not None:
            self.val_ir0 = self.val_ir0[:num_samples]
...
def main():
    ...
    train_dataset = _wrap_precomputed(train_dataset, config)
    ...
    val_dataset = _wrap_precomputed(val_dataset, config)
